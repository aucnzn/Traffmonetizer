...
- 感兴趣可以尝试一下，[注册链接点我](https://traffmonetizer.com/?aff=1756167), 走我链接注册你获得5刀的注册奖励。

## 安装

```shell
sudo bash -c "$(curl -fsSL https://raw.githubusercontent.com/baichal/Traffmonetizer/main/tm.sh)"
```
